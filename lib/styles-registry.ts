...
export const STYLES: StyleMeta[] = [
  ...
  { slug: 'playful-geometric', name: 'Playful Geometric', category: 'Creative', vibe: 'Fun geometric shapes', bestFor: 'Kids products, Creative tools', accentColor: '#FF6B6B', built: true, version: 'V1' },
  { slug: 'professional', name: 'Professional', category: 'Professional', vibe: 'Clean, business-focused', bestFor: 'Corporate sites, B2B platforms', accentColor: '#1E40AF', built: true, version: 'V1' },
  { slug: 'retro', name: 'Retro', category: 'Nostalgic', vibe: 'Vintage, nostalgic', bestFor: 'Retro brands, Gaming', accentColor: '#FF6B35', built: true, version: 'V1' },
  ...
  { slug: 'composio', name: 'Composio', category: 'Tech', vibe: 'Agentic workflows and automation clarity', bestFor: 'AI tools, developer platforms', accentColor: '#6366F1', built: true, version: 'V2' },
  { slug: 'cursor', name: 'Cursor', category: 'Tech', vibe: 'Next-gen code editing, dark and focused', bestFor: 'Developer tools, IDEs', accentColor: '#3B82F6', built: true, version: 'V2' },
  { slug: 'elevenlabs', name: 'ElevenLabs', category: 'Modern', vibe: 'Voice-AI focused, sleek and communicative', bestFor: 'Audio tech, AI tools', accentColor: '#10B981', built: true, version: 'V2' },
