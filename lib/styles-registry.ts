...
export const STYLES: StyleMeta[] = [
  ...
  { slug: 'luxury', name: 'Luxury', category: 'Elegant', vibe: 'Premium, elegant, sophisticated', bestFor: 'Luxury brands, High-end retail', accentColor: '#C0A060', built: true },
  ...
  { slug: 'organic', name: 'Organic', category: 'Organic', vibe: 'Natural, flowing forms', bestFor: 'Wellness, Natural products', accentColor: '#7CB87A', built: true },
  { slug: 'playful-geometric', name: 'Playful Geometric', category: 'Creative', vibe: 'Fun geometric shapes', bestFor: 'Kids products, Creative tools', accentColor: '#8B5CF6', built: true },
  { slug: 'professional', name: 'Professional', category: 'Professional', vibe: 'Clean, business-focused', bestFor: 'Corporate sites, B2B platforms', accentColor: '#B8860B', built: true },
  { slug: 'retro', name: 'Retro', category: 'Nostalgic', vibe: 'Vintage, nostalgic', bestFor: 'Retro brands, Gaming', accentColor: '#0000FF', built: true },
