  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <span className="font-bold text-lg" style={{ color: tokens.foreground }}>
          {PRODUCT_NAME}
        </span>
        ...
        >
          ...
          >
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="h-14 px-8 rounded-lg font-medium flex items-center gap-2"
              style={{ backgroundColor: tokens.accent, color: tokens.accentForeground }}
            >
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="h-14 px-8 rounded-lg font-medium border"
      ...
      <div className="max-w-4xl mx-auto px-6">
        <FadeUp>
          <div className="text-center">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8" style={{ color: tokens.foreground }}>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: tokens.foreground }}>Simple, transparent pricing</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {PRICING.map(tier => (
              ...
              >
                ...
                <h3 className="font-bold text-xl mb-1" style={{ color: tokens.foreground }}>{tier.name}</h3>
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full h-12 rounded-lg font-medium text-sm border"
      ...
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold" style={{ color: tokens.foreground }}>Loved by teams worldwide</h2>
          </div>
        </FadeUp>
        <StaggerContainer>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          {FAQ_ITEMS.map((item, i) => (
            <FadeUp key={i} delay={i * 0.05}>
              <div className="border rounded-xl overflow-hidden" style={{ borderColor: tokens.border }}>
                <button
  ...
  return (
    <section className="py-24 border-y" style={{ borderColor: tokens.border, backgroundColor: tokens.backgroundAlt }}>
      <div className="max-w-2xl mx-auto px-6 text-center">
        <FadeUp>
          <h2 className="text-4xl font-bold mb-4" style={{ color: tokens.foreground }}>Stay in the loop</h2>
          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="h-12 px-6 rounded-lg font-medium text-sm disabled:opacity-60"
                style={{ backgroundColor: tokens.accent, color: tokens.accentForeground }}
              >
