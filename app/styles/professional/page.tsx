  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <span className="font-semibold font-heading tracking-[-0.02em] text-lg" style={{ color: tokens.foreground }}>
          {PRODUCT_NAME}
        </span>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="px-5 h-10 rounded-md shadow-sm transition-all duration-200 hover:-translate-y-0.5 text-sm font-medium"
      ...
      <div className="max-w-6xl mx-auto px-6 py-32 w-full">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-semibold font-heading tracking-[-0.02em] leading-tight mb-6"
          ...
          >
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="h-14 px-8 rounded-md shadow-sm transition-all duration-200 hover:-translate-y-0.5 font-medium flex items-center gap-2"
              style={{ backgroundColor: tokens.accent, color: tokens.accentForeground }}
            >
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="h-14 px-8 rounded-md shadow-sm transition-all duration-200 hover:-translate-y-0.5 font-medium border"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {STATS.map(stat => (
              <motion.div key={stat.label} variants={staggerItem} className="text-center">
                <p className="text-4xl font-semibold font-heading tracking-[-0.02em] mb-1" style={{ color: tokens.foreground }}>{stat.value}</p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            <p className="small-caps mb-3" style={{ color: tokens.accent }}>Features</p>
            <h2 className="text-4xl md:text-5xl font-semibold font-heading tracking-[-0.02em] mb-4" style={{ color: tokens.foreground }}>
              Everything you need
            </h2>
      ...
      <div className="max-w-4xl mx-auto px-6">
        <FadeUp>
          <div className="text-center">
            <p className="small-caps mb-4" style={{ color: tokens.accent }}>About</p>
            <h2 className="text-4xl md:text-5xl font-semibold font-heading tracking-[-0.02em] mb-8" style={{ color: tokens.foreground }}>
  ...
  return (
    <section id="pricing" className="py-32" style={{ backgroundColor: tokens.background }}>
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            <p className="small-caps mb-3" style={{ color: tokens.accent }}>Pricing</p>
            <h2 className="text-4xl md:text-5xl font-semibold font-heading tracking-[-0.02em] mb-4" style={{ color: tokens.foreground }}>Simple, transparent pricing</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {PRICING.map(tier => (
              <motion.div
                key={tier.name}
                variants={staggerItem}
                className="p-8 rounded-xl border border-t-2 relative"
                style={{
              ...
              >
                ...
                <h3 className="font-semibold font-heading tracking-[-0.02em] text-xl mb-1" style={{ color: tokens.foreground }}>{tier.name}</h3>
                <div className="flex items-baseline gap-1 mb-2">
                  <span className="text-4xl font-semibold font-heading tracking-[-0.02em]" style={{ color: tokens.foreground }}>{tier.price}</span>
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full h-12 rounded-md shadow-sm transition-all duration-200 hover:-translate-y-0.5 font-medium text-sm border"
...
function Testimonials() {
  return (
    <section id="testimonials" className="py-32 border-y" style={{ borderColor: tokens.border, backgroundColor: tokens.backgroundAlt }}>
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            <p className="small-caps mb-3" style={{ color: tokens.accent }}>Testimonials</p>
            <h2 className="text-4xl md:text-5xl font-semibold font-heading tracking-[-0.02em]" style={{ color: tokens.foreground }}>Loved by teams worldwide</h2>
          </div>
        </FadeUp>
        <StaggerContainer>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
  ...
  return (
    <section id="faq" className="py-32" style={{ backgroundColor: tokens.background }}>
      <div className="max-w-3xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            <p className="small-caps mb-3" style={{ color: tokens.accent }}>FAQ</p>
            <h2 className="text-4xl md:text-5xl font-semibold font-heading tracking-[-0.02em]" style={{ color: tokens.foreground }}>Common questions</h2>
          </div>
        </FadeUp>
        <div className="space-y-4">
          {FAQ_ITEMS.map((item, i) => (
            <FadeUp key={i} delay={i * 0.05}>
                <div className="border border-t-2 rounded-xl overflow-hidden" style={{ borderColor: tokens.border }}>
                <button
  ...
  return (
    <section className="py-32 border-y" style={{ borderColor: tokens.border, backgroundColor: tokens.backgroundAlt }}>
      <div className="max-w-2xl mx-auto px-6 text-center">
        <FadeUp>
          <h2 className="text-4xl font-semibold font-heading tracking-[-0.02em] mb-4" style={{ color: tokens.foreground }}>Stay in the loop</h2>
          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              ...
              <input
                ...
                className="flex-1 h-12 px-4 rounded-md shadow-sm transition-all duration-200 hover:-translate-y-0.5 border border-t-2 text-sm"
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="h-12 px-6 rounded-md shadow-sm transition-all duration-200 hover:-translate-y-0.5 font-medium text-sm disabled:opacity-60"
                style={{ backgroundColor: tokens.accent, color: tokens.accentForeground }}
              >
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <p className="font-semibold font-heading tracking-[-0.02em] text-lg mb-3" style={{ color: tokens.foreground }}>{PRODUCT_NAME}</p>
...
export default function StylePage() {
  return (
    <div className={`${bodyFont.variable} ${headingFont.variable} ${monoFont.variable} font-sans`} style={{ backgroundColor: tokens.background }}>
