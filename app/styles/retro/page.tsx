...
// Using default fonts and utility classes for retro style to avoid issues with missing Google Fonts
import {
...
// ─────────────────────────────────────────────
// Using system fonts for true 90s feel where possible, or approximating
const headingFont = { variable: 'font-black uppercase tracking-wide' }; // We'll just use tailwind classes for the Arial Black look
const bodyFont = { variable: 'font-sans' };
const monoFont = { variable: 'font-mono' };
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <span className="font-black uppercase text-lg" style={{ color: tokens.foreground }}>
          {PRODUCT_NAME}
        </span>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="px-5 h-10 rounded-none bevel-outset transition-none text-sm font-medium"
      ...
      <div className="max-w-6xl mx-auto px-6 py-24 w-full">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-black uppercase leading-tight mb-6"
          ...
          >
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="h-14 px-8 rounded-none bevel-outset transition-none font-medium flex items-center gap-2"
              style={{ backgroundColor: tokens.accent, color: tokens.accentForeground }}
            >
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="h-14 px-8 rounded-none bevel-outset transition-none font-medium border"
...
function Stats() {
  return (
    <section className="border-none" style={{ borderColor: tokens.border, backgroundColor: tokens.backgroundAlt }}>
      <div className="max-w-6xl mx-auto px-6 py-12">
        <StaggerContainer>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {STATS.map(stat => (
              <motion.div key={stat.label} variants={staggerItem} className="text-center">
                <p className="text-4xl font-black uppercase mb-1" style={{ color: tokens.foreground }}>{stat.value}</p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black uppercase mb-4" style={{ color: tokens.foreground }}>
              Everything you need
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {FEATURES.map(feature => (
              <motion.div
                ...
                className="p-8 rounded-none bevel-inset bg-white border"
...
function ProductDetail() {
  return (
    <section className="py-24 border-none" style={{ borderColor: tokens.border, backgroundColor: tokens.backgroundAlt }}>
      <div className="max-w-4xl mx-auto px-6">
        <FadeUp>
          <div className="text-center">
            <p className="text-sm uppercase tracking-widest mb-4" style={{ color: tokens.accent }}>About</p>
            <h2 className="text-4xl md:text-5xl font-black uppercase mb-8" style={{ color: tokens.foreground }}>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black uppercase mb-4" style={{ color: tokens.foreground }}>Simple, transparent pricing</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {PRICING.map(tier => (
              <motion.div
                key={tier.name}
                variants={staggerItem}
                className="p-8 rounded-none bevel-inset bg-white border relative"
                style={{
              ...
              >
                ...
                <h3 className="font-black uppercase text-xl mb-1" style={{ color: tokens.foreground }}>{tier.name}</h3>
                <div className="flex items-baseline gap-1 mb-2">
                  <span className="text-4xl font-black uppercase" style={{ color: tokens.foreground }}>{tier.price}</span>
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full h-12 rounded-none bevel-outset transition-none font-medium text-sm border"
...
function Testimonials() {
  return (
    <section id="testimonials" className="py-24 border-none" style={{ borderColor: tokens.border, backgroundColor: tokens.backgroundAlt }}>
      <div className="max-w-6xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            <p className="text-sm uppercase tracking-widest mb-3" style={{ color: tokens.accent }}>Testimonials</p>
            <h2 className="text-4xl md:text-5xl font-black uppercase" style={{ color: tokens.foreground }}>Loved by teams worldwide</h2>
          </div>
        </FadeUp>
        <StaggerContainer>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="max-w-3xl mx-auto px-6">
        <FadeUp>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black uppercase" style={{ color: tokens.foreground }}>Common questions</h2>
          </div>
        </FadeUp>
        <div className="space-y-4">
          {FAQ_ITEMS.map((item, i) => (
            <FadeUp key={i} delay={i * 0.05}>
              <div className="border rounded-none bevel-inset bg-white overflow-hidden" style={{ borderColor: tokens.border }}>
                <button
  ...
  return (
    <section className="py-24 border-none" style={{ borderColor: tokens.border, backgroundColor: tokens.backgroundAlt }}>
      <div className="max-w-2xl mx-auto px-6 text-center">
        <FadeUp>
          <h2 className="text-4xl font-black uppercase mb-4" style={{ color: tokens.foreground }}>Stay in the loop</h2>
          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              ...
              <input
                ...
                className="flex-1 h-12 px-4 rounded-none bevel-outset transition-none border text-sm"
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="h-12 px-6 rounded-none bevel-outset transition-none font-medium text-sm disabled:opacity-60"
                style={{ backgroundColor: tokens.accent, color: tokens.accentForeground }}
              >
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <p className="font-black uppercase text-lg mb-3" style={{ color: tokens.foreground }}>{PRODUCT_NAME}</p>
...
export default function StylePage() {
  return (
    <div className="font-sans retro-bg" style={{ backgroundColor: tokens.background }}>
...
<style dangerouslySetInnerHTML={{__html: `
        ...
        @keyframes rainbow {
          ...
          50% { color: #00ff00; } 67% { color: #0080ff; } 83% { color: #8000ff; } 100% { color: #ff0000; }
        }
      `}} />
